...
<!--登录开始-->
    <div class="reg login">
        ...
        <form action="stuLogin.do" method="post" name="form1" id="form1" success="doSuccess()" >
            <dl>
                <div style="height:17px; overflow:hidden"></div>
                <dd><span tabindex="1" class="title">登录账号：</span><input class="reg_input" name="stuLoginName" id="stuLoginName" onblur="checkusername(this.value);" type="text" /><span id="t_UserNameTip" class="onshow"></span></dd>
                <dd><span tabindex="2" class="title">登录密码：</span><input class="reg_input" onblur="return checkpasswd(this);" id="stuLoginPwd" name="stuLoginPwd" type="password"/><span id="t_UserPassTip" class="onshow"></span></dd>
            </dl>
