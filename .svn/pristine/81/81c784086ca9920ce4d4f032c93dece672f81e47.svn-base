...
//					+ "<input class=\"messager-input\" type=\"text\"/>"
					+ "<textarea class=\"messager-input\" required='true'/>"
...
(function($) {
	...
	function _3ae(_3af) {
		...
		//_3b0(_3af);
		// edit by YF 2013-12-13
		$(_3af).find(".validatebox-invalid").each(function() {
...
(function($) {
	...
	function init(_70b) {
		...
		var _70c = $("<input type=\"text\" class=\"combo-text\">").appendTo(
				span);
