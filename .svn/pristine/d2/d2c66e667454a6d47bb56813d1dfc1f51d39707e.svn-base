...
<!-- <script type="text/javascript"
	src="js/website_login/js/jquery-1.4.4.min.js"></script>	 -->
<script type="text/javascript"
	src="js/website_login/js/jquery.XYTipsWindow.2.8.js"></script>
<script type="text/javascript" src="<c:url value="/js/json2.js" />"></script>
<script type="text/javascript"
	src="<c:url value="/js/jquery.form.min.js" />"></script>
<script type="text/javascript" src="js/website_login/js/websiteclear.js"></script>
<script type="text/javascript">
function doBg(){
	location = "tologin.do";
}
...
<div class="top">
	<div class="top_m">
		<div class="ding_right">
			<ul>
				<li><a href="javascript:openStuLoginDialog();">学生登录</a></li>
				<li><a href="">在线咨询</a></li>
				<li><a href="javascript:doBg();">教师入口</a></li>
			</ul>
		</div>
		<div class="top_i">
			<div class="top_img">
		...
		<div id="include_websiteclear_stuLoginDialog">
			<!--登录开始-->
		    <div class="reg login">
		        <form id="include_websiteclear_stuLoginForm" method="post" >
		            <dl>
		                <div style="height:17px; overflow:hidden"></div>
		                <dd><span tabindex="1" class="title">登录账号：</span><input class="reg_input easyui-validatebox" data-options="required:true" missingMessage="请输入登录账号" name="stuLoginName" id="stuLoginName" type="text" /><span id="t_UserNameTip" class="onshow"></span></dd>
		                <dd><span tabindex="2" class="title">登录密码：</span><input class="reg_input easyui-validatebox" data-options="required:true" missingMessage="请输入登录密码" id="stuLoginPwd" name="stuLoginPwd" type="password"/><span id="t_UserPassTip" class="onshow"></span></dd>
		            </dl>
		            <div class="f_reg_but"><input id="button" type="button" value="登录" onclick="doSubmit();" class="l_button"/><span class="clew_txt">还没账号？<a href="#">立即注册</a></span></div>
		        </form>                      
		    </div>
		<!--登录结束-->
		</div>
